...
import { USERADDDETAILINFO_NAMESPACE, BUYOO } from '@/common/constants';
...
export default {
  namespace: USERADDDETAILINFO_NAMESPACE,

  state: initState,

  effects: {
    *[ADD_DETAIL_INFO.REQUEST](action, { apply, put, select }) {
      const {
        usernameP,
        bank_name,
        bank_deposit,
    ...
    *[ADD_DETAIL_INFO.SUCCESS](action) {
  ...
  reducers: {
    [ADD_DETAIL_INFO.CLEAR]() {
      return {
        ...initState,
      };
    },
    [ADD_DETAIL_INFO.SUCCESS](state) {
      return {
        ...state,
        loading: false,
        loaded: true,
